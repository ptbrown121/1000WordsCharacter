...
export const els = {
    ...
    statDiceModalTitle: document.getElementById('stat-dice-modal-title'),
    statDiceModalKey: document.getElementById('stat-dice-modal-key'),
    statDiceInput: document.getElementById('stat-dice-input'),
    statDiceSelected: document.getElementById('stat-dice-selected'),
    statDiceButtonsGrid: document.getElementById('stat-dice-buttons'),
    btnStatDiceClear: document.getElementById('btn-stat-dice-clear'),
    btnStatDiceCancel: document.getElementById('btn-stat-dice-cancel'),
    btnStatDiceSave: document.getElementById('btn-stat-dice-save'),
